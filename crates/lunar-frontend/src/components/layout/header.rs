...
pub fn Header() -> Element {
    rsx! {
        header { class: "w-full flex items-center justify-between bg-black/60 backdrop-blur-md text-neutral-400 px-8 py-3.5 rounded-full border border-white/10 max-w-6xl mx-auto my-6 transition-all duration-300",
